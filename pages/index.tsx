        ...
        >
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg leading-relaxed text-gray-700">
              Dub Dogs Grooming is run by Bahar. She is a gentle and experienced
              groomer with a lifelong love of animals. She has a calm and patient
              approach that comes from years of caring for nervous and stray cats.
            </p>
            ...
            <p className="text-lg leading-relaxed text-gray-700 mt-6">
              Every session is one to one. There are no cages. There is no
              rushing. There is no noisy salon. Whether it’s a quick tidy-up or a
              full groom, your pet gets her full attention in a quiet and familiar
              setting.
            </p>
          </div>
        </section>
            ...
            <div className="grid gap-8 md:grid-cols-2 text-left">
              <div>
                ...
                <p className="text-gray-700">
                  Includes wash, dry, brush, full body trim, ear cleaning and nail
                  clipping
                </p>
              </div>
              <div>
